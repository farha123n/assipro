...
public class Unirestqw {
    ...
    public void post_method() throws UnirestException {
        HttpResponse<JsonNode> response = Unirest.post("https://gorest.co.in/public/v2/users")
                ...
                .queryString("Authorization", "Bearer 32c80880fe3786cc2f271303a83d13c186ffe28e512260b97fc4dd5c151ff64f")
                .field("name", "farhan")
    ...
    public void get_method() throws UnirestException {
        HttpResponse<JsonNode> response1 = Unirest.get("https://gorest.co.in/public/v2/users/23")
                .header("accept", "application/json")
                .queryString("Authorization", "Bearer 32c80880fe3786cc2f271303a83d13c186ffe28e512260b97fc4dd5c151ff64f")
    ...
    public void put_method() throws UnirestException {
        HttpResponse<JsonNode> response2 = Unirest.put("https://gorest.co.in/public/v2/users/23")
                .header("accept", "application/json")
                .queryString("Authorization", "Bearer 32c80880fe3786cc2f271303a83d13c186ffe28e512260b97fc4dd5c151ff64f")
                .field("name","far")
                .asJson();
